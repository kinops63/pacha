...
C_SRCS += \
../User/BLE/ble_advertising.c 

OBJS += \
./User/BLE/ble_advertising.o 

C_DEPS += \
./User/BLE/ble_advertising.d 


# Each subdirectory must supply rules for building sources it contributes
User/BLE/%.o User/BLE/%.su User/BLE/%.cyclo: ../User/BLE/%.c User/BLE/subdir.mk
...
clean: clean-User-2f-BLE

clean-User-2f-BLE:
	-$(RM) ./User/BLE/ble_advertising.cyclo ./User/BLE/ble_advertising.d ./User/BLE/ble_advertising.o ./User/BLE/ble_advertising.su

.PHONY: clean-User-2f-BLE
